...
public class DoubleExtractorTests
{
    ...
    public void Ctor_NoArguments_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new DoubleExtractor();

        // Assert
        Assert.That(extractor.MaxConsumption, Is.EqualTo(24));
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new DoubleExtractor(method);
    ...
    public void TryExtract_SomeArgument_ReturnsExpectedResult(DoubleExtractorTestDto testDto)
    {
        ...
        var extractor = new DoubleExtractor(terminator);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(DoubleExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(DoubleExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(DoubleExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public static IList<DoubleExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
