...
namespace TauCode.Data.Text.Tests.TextDataExtractor.Word;
...
public class WordExtractorTests
{
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new WordExtractor(method);
    ...
    public void TryExtract_SomeArgument_ReturnsExpectedResult(WordExtractorTestDto testDto)
    {
        // Arrange
        ...
        var extractor = new WordExtractor(terminator);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(WordExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(WordExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(WordExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public static IList<WordExtractorTestDto> GetTestDtos()
    {
        var json = typeof(WordExtractorTests).Assembly.GetResourceText(
            $".{nameof(WordExtractorTests)}.json",
            true);

        var dtos = JsonConvert.DeserializeObject<IList<WordExtractorTestDto>>(json);
    ...
    public static IList<WordExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
