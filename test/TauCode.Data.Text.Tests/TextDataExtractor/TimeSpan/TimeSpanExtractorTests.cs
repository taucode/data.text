...
public class TimeSpanExtractorTests
{
    ...
    public void Ctor_NoArguments_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new TimeSpanExtractor();

        // Assert
        Assert.That(extractor.MaxConsumption, Is.EqualTo(26));
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new TimeSpanExtractor(method);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(TimeSpanExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        ...
        var extractor = new TimeSpanExtractor(terminator);
        if (testDto.TestMaxConsumption == -1)
        {
            // do nothing
        }
        ...
        {
            // fail
            var value = System.TimeSpan.Parse("01:01:02");
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(TimeSpanExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(TimeSpanExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public static IList<TimeSpanExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
