...
public class JsonStringExtractorTests
{
    ...
    public void Ctor_NoArguments_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new JsonStringExtractor();
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new JsonStringExtractor(method);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(JsonStringExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        ...
        var extractor = new JsonStringExtractor(terminator);
        if (testDto.TestMaxConsumption == -1)
        {
            // do nothing
        }
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(JsonStringExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(JsonStringExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate terminator =
    ...
    public static IList<JsonStringExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
