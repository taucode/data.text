...
public class CLangStringExtractorTests
{
    ...
    public void Ctor_NoArguments_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new CLangStringExtractor();
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new CLangStringExtractor(method);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(CLangStringExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        ...
        var extractor = new CLangStringExtractor(terminator);
        if (testDto.TestMaxConsumption == -1)
        {
            // do nothing
        }
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(CLangStringExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(CLangStringExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public static IList<CLangStringExtractorTestDto> GetTestDtos()
    {
    ...
    public static IList<CLangStringExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
