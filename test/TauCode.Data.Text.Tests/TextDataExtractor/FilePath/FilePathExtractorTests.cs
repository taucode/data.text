...
public class FilePathExtractorTests
{
    ...
    public void Ctor_NoArguments_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new FilePathExtractor();

        // Assert
        Assert.That(extractor.MaxConsumption, Is.EqualTo(260));
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new FilePathExtractor(method);
    ...
    public void TryExtract_SomeArgument_ReturnsExpectedResult(FilePathExtractorTestDto testDto)
    {
        ...
        var extractor = new FilePathExtractor(terminator);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(FilePathExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(FilePathExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(FilePathExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public static IList<FilePathExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
