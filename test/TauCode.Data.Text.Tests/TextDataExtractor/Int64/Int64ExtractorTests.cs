...
public class Int64ExtractorTests
{
    ...
    public void Ctor_NoArguments_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new Int64Extractor();

        // Assert
        Assert.That(extractor.MaxConsumption, Is.EqualTo(20));
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new Int64Extractor(method);
    ...
    public void TryExtract_SomeArgument_ReturnsExpectedResult(Int64ExtractorTestDto testDto)
    {
        ...
        var extractor = new Int64Extractor(terminator);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(Int64ExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(Int64ExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(Int64ExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate? terminator =
    ...
    public static IList<Int64ExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
