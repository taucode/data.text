...
public class KeyExtractorTests
{
    ...
    public void Ctor_NoArguments_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new KeyExtractor();
    ...
    public void Ctor_ValidArgument_CreatesExtractor()
    {
        ...
        // Act
        var extractor = new KeyExtractor(method);
    ...
    public void TryExtract_SomeArgument_ReturnsExpectedResult(KeyExtractorTestDto testDto)
    {
        // Arrange
        ...
        var extractor = new KeyExtractor(terminator);
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtos))]
    public void Extract_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(KeyExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate terminator =
    ...
    public void TryParse_SomeArgument_ReturnsExpectedResult(KeyExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate terminator =
    ...
    [Test]
    [TestCaseSource(nameof(GetTestDtosWithoutTerminator))]
    public void Parse_SomeArgument_ReturnsExpectedResultOrThrowsExpectedException(KeyExtractorTestDto testDto)
    {
        // Arrange
        var input = testDto.TestInput;
        TerminatingDelegate terminator =
    ...
    public static IList<KeyExtractorTestDto> GetTestDtos()
    {
        var json = typeof(KeyExtractorTests).Assembly.GetResourceText(
            $".{nameof(KeyExtractorTests)}.json",
            true);

        var dtos = JsonConvert.DeserializeObject<IList<KeyExtractorTestDto>>(json);
    ...
    public static IList<KeyExtractorTestDto> GetTestDtosWithoutTerminator() =>
        GetTestDtos()
